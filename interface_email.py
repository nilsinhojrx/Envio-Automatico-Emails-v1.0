...
from tkinter import * ; from tkinter import filedialog; # Importações em uma única linha
...
entry_senha.configure(show="*") #Oculatar os caracteres da senha
...
entry_msg = tk.Entry(top,justify='left')
entry_msg.place(relx=0.05, rely=0.5, height=120, relwidth=0.8)
